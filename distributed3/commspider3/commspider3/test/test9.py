    ...
    try:
        ...
        if times > 0:
            ...
            with open('error.log', 'ab+') as fp:
                fp.write('第' + str(page_num) + u'页数据始终异常...' + '\n')
                fp.write(url + u'地址异常...' + '\n')
                fp.write('=' * 30 + '\n')
            return
...
headers = {
    ...
    # 'Host':'ha.gsxt.gov.cn',
    # 'referer': 'http://news.baidu.com/finance',
...
url = 'http://stock.10jqka.com.cn/hks/20171027/c601185387.shtml'
url2 = 'http://news.china.com/finance/11155042/20171027/31608415_all.html'
...
print(a.url)
print(a.headers)
resp = etree.HTML(a.content)
# b = resp.xpath('//div[@class="atc-content"]')[0].xpath('string(.)')
b = resp.xpath('//div[@class="atc-head" or @class="text-title"]/h1/text()')
print(b)
